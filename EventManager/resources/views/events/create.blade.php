        ...
        <form id="createEventForm" action="{{ route('events.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="4"
                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-200 focus:border-blue-500">{{ old('description') }}</textarea>
                @error('description')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <p id="dateError" class="text-red-500 text-xs mt-1 hidden">
...
<!-- Script para validar as datas no front-end -->
<script>
    document.getElementById('createEventForm').addEventListener('submit', function(event) {
        ...
        // Se a data/hora de início for maior ou igual à data/hora de término, exibimos o erro e impedimos o envio
